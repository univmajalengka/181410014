...
if (isset($_POST['login'])) {
	...
	$pwd = md5(mysqli_escape_string($conn, $_POST['pwd']));
...
elseif (isset($_POST['add_siswa'])) {
	...
	$email = mysqli_real_escape_string($conn, $_POST['email']);
	$pwd = mysqli_real_escape_string($conn, md5($_POST['pwd_cek']));
	$pwd_cek = mysqli_real_escape_string($conn, md5($_POST['pwd']));
...
elseif (isset($_POST['change-pwd'])) {
	...
	$cek = md5(mysqli_real_escape_string($conn, $_POST['new-pwd-cek']));
